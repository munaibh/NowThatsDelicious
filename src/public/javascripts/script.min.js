...
},{"./modules/autocomplete":29,"./modules/bling":30,"./modules/heart":31,"./modules/map":32,"./modules/typeAhead":33}],29:[function(require,module,exports){
'use strict';
...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    ...
    (0, _bling.$)('.heart-count').textContent = res.data.user.hearts.length;
    _this.querySelector('.button__heart__count').textContent = res.data.likes;
    if (isHearted) {
...
},{"./bling":30,"axios":1}],32:[function(require,module,exports){
'use strict';
...
},{"./bling":30,"axios":1}],33:[function(require,module,exports){
'use strict';
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search/' + this.value).then(function (res) {
      if (res.data.length) {
